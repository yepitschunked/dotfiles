...
"============================================================================
"                                                               
"" For quickly inserting URLs, uses the X11 buffer as the paste source.
imap UU [[<ESC>"*pa][<++>]] <++> <C-J>

"" For "fixing" a non-twiki word: SysAdmin.Vim --> [[SysAdmin.Vim][Vim]]
imap <C-F> <ESC>b"oyeBi[[<ESC>Ea][<ESC>"opa]] 

"" For "jumping" to the next marker <+optional caption inside+>
imap <C-J> <ESC>0/<+[^+]*+><CR>df>i

"" For quickly setting up a link box
imap LL [[<++>][<++>]] <++> <C-J>

"" For easily inserting verbatim text
imap <v <verbatim><CR><++><CR></verbatim><CR><++> <ESC>3ki<C-J>

"" Some rules for common markup symbols
imap == =<++>= <++> <C-J>
imap __ _<++>_ <++> <C-J>
imap ** *<++>* <++> <C-J>
